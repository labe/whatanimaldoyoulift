...
namespace :db do
  ...
  task :migrate do
    ...
    ActiveRecord::MigrationContext.new(ActiveRecord::Migrator.migrations_paths, ActiveRecord::SchemaMigration).migrate(ENV["VERSION"] ? ENV["VERSION"].to_i : nil) do |migration|
